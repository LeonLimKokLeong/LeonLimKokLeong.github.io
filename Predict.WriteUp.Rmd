...
print(MatrixRF)
```
This training model gives us a close to 100% accuracy at 99.72%.

#Prediction
We proceed with predicting the actual test data.
```{r}
########################
## predict the result ##
########################
...
This training model with reduced features also gives us an accuracy at 99.72%. We run the new model with the actual test data.
